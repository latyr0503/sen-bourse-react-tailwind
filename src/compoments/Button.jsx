...
const Button = (props) => {
  return (
    <button className="relative group cursor-pointer text-sky-50  overflow-hidden h-12 w-64 rounded-md bg-sky-800 p-2 flex justify-center items-center font-extrabold">
      ...
      <p className="z-10">{props.texte}</p> 
    </button>
  );
};
